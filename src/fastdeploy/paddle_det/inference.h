...
/// @return 返回分类标签
MY_DLL DET_RES doInferenceByImgPth(const char* image_pth, void* model_ptr, char* msg, size_t msg_len=1024);
...
/// @param msg_len 指定返回消息的长度 默认1024
/// @return 返回分类标签
MY_DLL DET_RES doInferenceBy3chImg(uchar* image_arr, const int height, const int width, void* model_ptr, char* msg, size_t msg_len=1024);
...
/// @param msg_len 指定返回消息的长度 默认1024
/// @return 返回分类标签
MY_DLL DET_RES doInferenceBy3chBatchImgs(uchar** image_arr, const std::size_t img_num, const int height, const int width, void* compiled_model, char* msg, size_t msg_len=1024);
...
DET_RES doInferenceByImgMat(const cv::Mat& img_mat, void* compiled_model, char* msg, size_t msg_len=1024);
