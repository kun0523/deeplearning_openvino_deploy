...
void testInterface(){
    ...
    std::string cls_model_pth2{R"(D:\share_dir\impression_detect\src\vs2015CallDll\test_models\for_cls\best.onnx)"};
...
int main(){
    std::cout << "Test OpenVINO Inference All in One" << std::endl;
